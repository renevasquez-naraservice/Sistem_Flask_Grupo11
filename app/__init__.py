...
def create_app(config_class=Config):
    ...
    from .routes.dashboard_ai import dashboard_ai_bp        # De dashboard_ai.py    
    from .routes.chat_bot import chatbot_bp        # De chat_bot.py
    ...
    app.register_blueprint(dashboard_ai_bp)         # Registrar el blueprint de dashboard IA
    app.register_blueprint(chatbot_bp)         # Registrar el blueprint de chatbot  
